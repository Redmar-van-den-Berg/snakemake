...
class Env:
    ...
    def __init__(
        self, env_file, workflow, env_dir=None, cleanup=None
    ):
        self.file = env_file
    ...
    def archive_file(self):
        """Path to archive of the spack environment, which may or may not exist."""
    ...
    def create_archive(self):
        ...
        try:
            print("TRY DOWNLOAD SPACK.py")
            import IPython
            IPython.embed()
            # Download
            logger.info(
                "Downloading packages for spack environment {}...".format(self.file)
            )
